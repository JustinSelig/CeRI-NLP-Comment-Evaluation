...
When prompted, specify the file path of the excel spreadsheet containing your manual and automatically parsed comments. There are two test files included in this package.
